...
class DbConnectionMeta(type):
    ...
    def __subclasscheck__(self, __subclass: type) -> bool:
        return hasattr(__subclass, "connect") and callable(__subclass.connect)  # type: ignore[attr-defined]
...
class PageLoader:
    ...
    def load_page(self, url: str) -> Any:
        return self.db_connection.connect()  # type: ignore[attr-defined]
